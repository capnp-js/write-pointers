...
function browserRollup() {
  return rollup({
    ...
    bundle.write({
      file: "browser/capnp-js-write-pointers.js",
      format: "umd",
      name: "capnpJsWritePointers",
      sourcemap: true,
      globals: {
...
function browserUglify() {
  return new Promise((resolve, reject) => {
    fs.readFile("browser/capnp-js-write-pointers.js.map", (err, map) => {
      if (err) {
        reject(err);
      } else {
        const ugly = gulp.src("browser/capnp-js-write-pointers.js")
          .pipe(uglify({
            sourceMap: {
              content: map.toString(),
              url: "capnp-js-write-pointers.js.map",
            },
          }))
